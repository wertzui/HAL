namespace System.Text.Json.Serialization
{
    ...
    /// cref="JsonEnumConverter"/>.
    /// </summary>
    [AttributeUsage(AttributeTargets.Enum, AllowMultiple = false, Inherited = false)]
    public sealed class JsonEnumConverterOptionsAttribute : Attribute
    {
        /// <summary>
        /// Gets the <see cref="JsonEnumConverterOptions"/>
        /// generated for the attribute.
        /// </summary>
        public JsonEnumConverterOptions? Options { get; }

        /// <summary>
        /// Initializes a new instance of the <see
        /// cref="JsonEnumConverterOptionsAttribute"/> class.
        /// </summary>
